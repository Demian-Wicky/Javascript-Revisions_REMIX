...
const firstNames = entrepreneurs.map(entrepreneur => entrepreneur.first + " " + entrepreneur.last)
...
const newArrayWithAge = entrepreneurs.map(entrepreneur => {
    return {first: entrepreneur.first, last: entrepreneur.last, age: ((new Date().getFullYear()) - entrepreneur.year)}
})
console.log(newArrayWithAge)

// Les clés first et last manquent de lisibilité, remplace-les par firstName et lastName
const newArrayWithBetterKeys = entrepreneurs.map(entrepreneur => {
